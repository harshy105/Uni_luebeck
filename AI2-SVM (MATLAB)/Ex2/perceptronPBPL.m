...
index = 1; %initialsing the data index once and then loop over the entire data set to update the perceptron value
...
while ((~exit) && (iter < maxIter))
    ...
    %looping over the new data set to check if any of the perceptron output is zero 
